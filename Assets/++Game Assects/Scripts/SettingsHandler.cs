...
public class SettingsHandler : MonoBehaviour
{
    ...
    private void SetGraphicsAttributes()
    {
        ...
        SetScreenBrightness(GraphicSetting.BrightnessSlider_val);
        SetGameFrameRate(GraphicSetting.FrameRate_val);
        SetGameGraphics(GraphicSetting.Graphic_val);

        Debug.LogWarning("GraphicSetting.FrameRate "+ GraphicSetting.FrameRate_val);
        Debug.LogWarning("GraphicSetting.Graphic_val "+ GraphicSetting.Graphic_val);
        Debug.LogWarning("GraphicSetting.BrightnessSlider_val "+ GraphicSetting.BrightnessSlider_val);
